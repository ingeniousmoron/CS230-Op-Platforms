...
public class GameService {
	 ...
	 */
	private static GameService newServer;
	...
	public static GameService getNewServer() {
		if (newServer == null) {
			newServer = new GameService();
		}
	...
	/**
	 * The singleston design pattern ensures that only one instance of
